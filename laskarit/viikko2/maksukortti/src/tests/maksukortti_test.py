...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_voi_ostaa_edullisen_lounaan_kun_saldoa_on_tasan_edullisen_lounaan_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_kortilla_voi_ostaa_maukkaan_lounaan_kun_saldoa_on_tasan_maukkaan_lounaan_verran(self):
